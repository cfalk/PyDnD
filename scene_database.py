...
scene_database = {
	...
	11.1  	:["You find a watering well. It seems to be pondering its existence -- or so the splashing from inside implies.",
			["Go West","Go North", "Go East"], [10, 12, 15], "52,54"],###Completely change (look into well)
	...
	14  	:["You arrive at the front gate of Townington. You can see a burly man arm wrestling himself outside a nearby inn.",
			["Explore the Town", "Leave Townington", "Approach the Man"], [101, 13, 19], "54,49"],
